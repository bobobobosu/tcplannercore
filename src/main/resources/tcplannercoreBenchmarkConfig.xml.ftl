        ...
        <solver>
            ...
            <localSearch>
                ...
                <#if lateAcceptance != "" || tabu != "" || mtabu != "" || umtabu != "">
                    <acceptor>
                        <simulatedAnnealingStartingTemperature>[${startingTemperature}/${startingTemperature}
                            /${startingTemperature}/${startingTemperature}/${startingTemperature}]hard/[0/0/0/0]soft
